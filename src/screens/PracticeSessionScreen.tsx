...
const PracticeSessionScreen: React.FC<PracticeSessionScreenProps> = ({navigation}) => {
    ...
    if (!currentKanji) {
        return (
            <View style={styles.emptyContainer}>
                ...
                <Button onPress={() => navigation.goBack()}>Return to Dashboard</Button>
            </View>
        );
    }
                    ...
                    <View style={styles.stars}>
                        {[...Array(3)].map((_, i) => (
                            <Ionicons
                                key={i}
                                name={
                                    i < (currentKanji.difficulty === 'beginner' ? 1 : currentKanji.difficulty === 'intermediate' ? 2 : 3)
                                        ? 'star'
                                        : 'star-outline'
                                }
                                size={16}
            ...
            {showResult ? (
                <Card style={styles.resultCard}>
                    ...
                    <Text style={styles.resultTitle}>
                        {lastAccuracy >= 90 ? 'Excellent!' : lastAccuracy >= 70 ? 'Good Job!' : 'Keep Trying!'}
                    </Text>
                    <Text style={styles.resultAccuracy}>
                        Accuracy: <Text style={styles.resultAccuracyValue}>{lastAccuracy}%</Text>
                    </Text>
