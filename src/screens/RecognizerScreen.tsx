...
const KanjiCandidatesGrid = ({kanjiList, onSelectKanji}: {
...
export default function RecognizerScreen({navigation}: { navigation: any }) {
    ...
    const onSelectKanji = (item: RecognizedKanjiDto) => {
        navigation.navigate('Kanji', {
            screen: 'KanjiDetail',
            params: {kanjiUuid: item.uuid, character: item.character}
        });
    };
                ...
                <GestureHandlerRootView style={styles.contentContainer}>
                    ...
                    <View style={styles.resultsContainer}>
                        {isLoading ? (
                            ...
                            <View style={styles.centerState}>
                                <Ionicons name="brush-outline" size={32} color={JP_THEME.textMuted}
                                          style={{opacity: 0.5}}/>
                        ...
                        >
                            <View style={styles.buttonContent}>
                                <Ionicons name="trash-outline" size={18}
                                          color={isResetDisabled ? '#cbd5e1' : JP_THEME.accent}/>
                                <Text
                                    style={[styles.buttonText, {color: isResetDisabled ? '#cbd5e1' : JP_THEME.accent}]}>Clear</Text>
                            </View>
                        </TouchableOpacity>
                        ...
                        >
                            <View style={styles.buttonContent}>
                                <Ionicons name="arrow-undo" size={18}
                                          color={isUndoDisabled ? '#cbd5e1' : JP_THEME.textMuted}/>
                                <Text
                                    style={[styles.buttonText, {color: isUndoDisabled ? '#cbd5e1' : JP_THEME.textMuted}]}>Undo</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
