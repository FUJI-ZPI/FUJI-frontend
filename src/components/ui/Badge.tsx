...
export const Badge: React.FC<BadgeProps> = ({ children, variant }) => {
  ...
  if (variant === 'primary') {
    ...
    badgeStyles = { ...badgeStyles, backgroundColor: colors.lightBackground, borderColor: colors.primary, borderWidth: 1 };
    textStyles = { ...textStyles, color: colors.primary };
  } else if (variant === 'warning') {
    badgeStyles = { ...badgeStyles, backgroundColor: colors.warning + '20', borderColor: colors.warning, borderWidth: 1 };
