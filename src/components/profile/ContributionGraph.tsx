    ...
    const getActivityColor = (level: number) => {
        switch (level) {
            case 0:
                return '#F1F5F9';
            case 1:
                return JP_THEME.red100;
            case 2:
                return JP_THEME.red200;
            case 3:
                return JP_THEME.red300;
            case 4:
                return JP_THEME.red500;
            default:
                return '#F1F5F9';
        }
    };
            ...
            <View style={styles.cardHeader}>
                ...
                <View style={styles.controlsRow}>
                    ...
                    <Text style={styles.dateRangeText}>
                        {startDateDisplay ? `${startDateDisplay.toLocaleDateString('en-US', {
                            month: 'short',
                            day: 'numeric'
                        })} - ${endDateDisplay?.toLocaleDateString('en-US', {month: 'short', day: 'numeric'})}` : ''}
                    </Text>
