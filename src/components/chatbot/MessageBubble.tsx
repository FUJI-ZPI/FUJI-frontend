    ...
    return (
        <View style={styles.messageGroupContainer}>
            <View style={[styles.messageRow, isUser ? styles.userRow : styles.aiRow]}>
                ...
                {isUser && (
                    <View style={styles.avatarContainer}>
                        <Image source={userAvatar ? {uri: userAvatar} : undefined}
                               style={[styles.userAvatar, !userAvatar && {backgroundColor: "rgb(54, 138, 89, 0.2)"}]}/>
            ...
            {isTranslationRendered && (
                <Animated.View style={[styles.translationRow, isUser ? styles.userRow : styles.aiRow, animatedStyle]}>
                    ...
                    <View
                        style={[styles.translationBubble, isUser ? styles.userTranslation : styles.aiTranslationContent]}>
